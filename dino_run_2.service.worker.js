...
/** @type {string} */
const CACHE_VERSION = '1728128786|3039190204';
/** @type {string} */
const CACHE_PREFIX = 'dino_run_2-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'dino_run_2.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["dino_run_2.html","dino_run_2.js","dino_run_2.offline.html","dino_run_2.icon.png","dino_run_2.apple-touch-icon.png","dino_run_2.worker.js","dino_run_2.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["dino_run_2.wasm","dino_run_2.pck"];
